...
ItemConfig.ItemData.SystemName = "item_minihealer"
ItemConfig.MetaData.ItemIcon = "med_bints"
...
ItemConfig.MetaData.ItemName = "Bandage"
...
function ItemConfig.ItemData.SystemFunctions:ScreenDraw_First(item_config,W,H)
	...
	surface.SetMaterial(Material("kishkixd/objects/med_bints.png"))
